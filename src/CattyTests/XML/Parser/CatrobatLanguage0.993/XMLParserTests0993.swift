...
class XMLParserTests0993: XMLAbstractTest {
    ...
    func testFlashBrick() {
        let project = self.getProjectForXML(xmlFile: "LedFlashBrick0993")
    ...
    func testIfThenLogicBeginBrick() {
        let project = self.getProjectForXML(xmlFile: "LogicBricks_0993")
    ...
    func testObjectLookSensors() {
        let project = self.getProjectForXML(xmlFile: "Sensors_0993")
    ...
    func testChooseCameraBrick() {
        ...
        let project = self.getProjectForXML(xmlFile: "CameraBricks_0993")
        let background = (project.scenes[0] as! Scene).object(at: 0)!
    ...
    func testNumberOfItemsFunction() {
        let project = self.getProjectForXML(xmlFile: "NumberOfItemsInListFunction0993")
        XCTAssertEqual(1, (project.scenes[0] as! Scene).objects().count, "Invalid object list")
    ...
    func testElementOfListFunction() {
        let project = self.getProjectForXML(xmlFile: "ElementOfListFunction0993")
        XCTAssertEqual(1, (project.scenes[0] as! Scene).objects().count, "Invalid object list")
    ...
    func testDeleteItemOfUserListBrick() {
        let project = self.getProjectForXML(xmlFile: "DeleteItemOfUserListBrick0993")
        XCTAssertEqual(1, (project.scenes[0] as! Scene).objects().count, "Invalid object list")
    ...
    func testInsertItemIntoUserListBrick() {
        let project = self.getProjectForXML(xmlFile: "InsertItemIntoUserListBrick0993")
        XCTAssertEqual(1, (project.scenes[0] as! Scene).objects().count, "Invalid object list")
    ...
    func testDisabledBricks() {
        let project = self.getProjectForXML(xmlFile: "DisabledBricks_0993")
        let object = (project.scenes[0] as! Scene).object(at: 0)!
    ...
    func testAskBrick() {
        let project = self.getProjectForXML(xmlFile: "ValidProjectAllBricks0993")
        let askBrick = ((project.scenes[0] as! Scene).object(at: 1)!.scriptList.object(at: 0) as! Script).brickList.object(at: 1) as! Brick
    ...
    func testJoinThreeFunction() {
        ...
        XCTAssertEqual(formula!.formulaTree.value as String, "JOIN3")
    }
}
